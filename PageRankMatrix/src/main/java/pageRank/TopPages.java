...
public class TopPages {
	...
	extends Mapper<Object, Text, NullWritable, Text> {
		...
		private TreeMap<Double, Long> topNodeMap = new TreeMap<Double, Long>();
		...
		public void map(Object key, Text value, Context context)
			...
			if(topNodeMap.size() > 100) {
				...
				topNodeMap.remove(topNodeMap.firstKey());
			}
		}
	...
	extends Reducer<NullWritable, Text, Text, DoubleWritable> {
		...
		private TreeMap<Double, Long> topNodesMap = new TreeMap<Double, Long>(Collections.reverseOrder());
