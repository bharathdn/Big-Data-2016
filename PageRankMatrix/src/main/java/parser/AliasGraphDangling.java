...
public class AliasGraphDangling {
	...
	extends Mapper<Object, Text, Text, Text> {
		...
		// this method is not used in the computation
	...
	public static void NodeAliasDriver(String[] args) 
		...
		job.setJarByClass(AliasGraphDangling.class);
	...
	public static void main(String[] args) throws Exception {
		System.out.println("CREATING ALIASED DANGLING");
