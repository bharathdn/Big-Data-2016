 ...
 */
public class WeatherAnalyzer1A {
	...
	public static void WeatherAnalyzer1ADriver(String[] args) throws Exception { 
		Configuration conf = new Configuration();

//		App.deleteDir(new File(args[1]));
		Job job = Job.getInstance(conf, "Weather Mean Computation 1A");
